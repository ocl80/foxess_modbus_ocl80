...
def _h1_current_voltage_power_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31006], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31007], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31010], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
        entity_registry_enabled_default=False,
        name="EPS Voltage",
        device_class=SensorDeviceClass.VOLTAGE,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31011], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
        entity_registry_enabled_default=False,
        name="EPS Current",
        device_class=SensorDeviceClass.CURRENT,
...
def _inverter_entities() -> Iterable[EntityFactory]:
    ...
    yield _invbatvolt(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31020], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
    )
    ...
    yield _invbatcurrent(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31021], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
    )
    yield _invbatcurrent(
    ...
    yield from _invbatpower(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31022], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31009], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31013], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31018], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31019], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusBatterySensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31025], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
        entity_registry_enabled_default=False,
    ...
    yield ModbusBatterySensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31026], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133 | Inv.KH_133),
        ],
        entity_registry_enabled_default=False,
        bms_connect_state_address=BMS_CONNECT_STATE_ADDRESS,
    ...
    yield _solar_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32001, 32000], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _solar_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32002], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _battery_charge_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32004, 32003], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133 ),
    ...
    yield _battery_discharge_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32007, 32006], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133 ),
    ...
    yield _battery_discharge_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32008], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _feed_in_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32010, 32009], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _feed_in_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32011], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _grid_consumption_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32013, 32012], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _grid_consumption_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32014], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _total_yield_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32016, 32015], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _total_yield_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32017], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _input_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32019, 32018], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _input_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32020], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield _load_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32023], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
...
def _bms_entities() -> Iterable[EntityFactory]:
    ...
    yield from _inner(
        ...
        battery_soc=[
            ...
            ModbusAddressesSpec(holding=[31024], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2
                                | Inv.KH_PRE133 | Inv.KH_133),
            ModbusAddressesSpec(holding=[31038], models=Inv.H3_SET),
        ],
        battery_temp=[
            ModbusAddressesSpec(input=[11038], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[31023], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2
                                | Inv.KH_PRE133 | Inv.KH_133),
...
def _configuration_entities() -> Iterable[EntityFactory]:
    yield ModbusWorkModeSelectDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41000, models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET | Inv.KH_PRE133 | Inv.KH_133),
        ],
        name="Work Mode",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41007], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133 ),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41008], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41009], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41010], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41011], models=Inv.H1_G1 | Inv.H1_G2 | Inv.H3_SET
                                | Inv.KH_PRE133 | Inv.KH_133),
